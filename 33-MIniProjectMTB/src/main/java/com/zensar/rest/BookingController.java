...
import com.zensar.service.BookingService;
...
public class BookingController {
	...
	@DeleteMapping(value = "/deletebooking/{bid}")
	public TicketBooking deletef3(@PathVariable(name="bid") int bookingid) {
	...
	public List<TicketBooking> showAllBookingf5(@PathVariable(name = "d") LocalDate date) {
		return this.bookingService.showAllBookings(date);
	}
